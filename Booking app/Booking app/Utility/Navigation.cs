...
namespace Booking_app.Utility
{
    static class Navigation
    {
        ...
        public static Dictionary<string,Type> PageDictionary = new Dictionary<string, Type> {{"MainPage",typeof(Booking_app.View.MainPage) }, {"Login", typeof(Login)}, {"BookPage", typeof(BookPage)},{"CreateUser", typeof(CreateUser)}, {"UserInfo", typeof(UserInfo)}};
